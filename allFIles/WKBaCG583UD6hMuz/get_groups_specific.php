...
$numbers = array( "Politics", "Politics", "Celebrities", "Music", "Technology", "Fashion", "Business", "School", "Art", "Photography", "LGBT", "Relationships", "Sports", "Funny", "Confessions", "Personal", "Sex", "Family", "Work", "Faith", "Food", "Entertainment", "Women Issues", "Health", "Men Issues", "Science", "Teens" );
...
groups.id_categories as id_categories,  
	...
	while($row = mysqli_fetch_assoc($q)){
		$json[] = array(
            $row['user_nick_name'] = $random_names[$row['group_id']],
            $row['avatar_url'] = $random_avatar[$row['group_id']],
            $row['category_name'] = $numbers[$row['id_categories']],
