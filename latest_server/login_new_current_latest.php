...
$email = isset($_POST['email']) ? mysqli_real_escape_string($con, $_POST['email']) : $random_email;
$user_id = isset($_POST['user_id']) ? mysqli_real_escape_string($con, $_POST['user_id']) : $randomuserID;
$socialNetwork = isset($_POST['socialNetwork']) ? mysqli_real_escape_string($con, $_POST['socialNetwork']) : 0;
$date = date_create();
$created = date_timestamp_get($date);

$deviceId = isset($_POST['deviceId']) ? mysqli_real_escape_string($con, $_POST['deviceId']) : $random_device;

$blockUsersql = "SELECT id_user_name FROM candid_database.block_user_from_app where device_id ='$deviceId' ";
