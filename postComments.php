...
$sql = mysqli_query($con, "INSERT INTO `post_comments` (`id_user_name`, `id_posts`,  `id_post_user_name` , `id_user_name_random`, `message`, `comment_time`,`level`,`random_color_light`,`random_color_dark`) VALUES ('$id_user_name', '$id_posts', $id_post_user_name, '$id_user_name_random', '$message','$post_date','0','$light_color','$dark_color')") or die(mysqli_error($con));
