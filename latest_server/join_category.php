...
mysqli_query($con,"DELETE FROM candid_database.group_category_join WHERE id_user_name = '".$user_id."'");
mysqli_query($con,"SET SQL_SAFE_UPDATES = 1");


$sql = mysqli_prepare($con, "INSERT INTO `group_category_join`(`id_categories`, `id_user_name`, `created_at`) VALUES (?,?,?)");
