...
require_once("send_topic_broadcast.php");
...
WHERE c.id_posts = $id_posts ORDER BY c.comment_time asc ";
    ...
    $topic = "Someone Commented on your post in ";
...
// send notification to post owner
    ...
    $group_name = $getData-> group_name;

    $sendTopicBroadcast = send_topic_broadcast($id_posts, $topic02, $userId, $group_name);
