...
$sql = "SELECT posts.id_posts, posts.id_user_name, posts.group_id, posts.post_time, 
...
(SELECT feeling_likes FROM feeling_category WHERE id_user_name= $user_id and feeling_category.id_posts = posts.id_posts) as feeling_like, 
(SELECT count(feeling_likes) FROM feeling_category WHERE feeling_category.id_posts = posts.id_posts and feeling_likes = 1) as likes,  
(SELECT count(feeling_likes) FROM feeling_category WHERE feeling_category.id_posts = posts.id_posts and feeling_likes = 2) as hug, 
(SELECT count(post_comments.id_post_comments) as comments 
...
where post_comment_reply.id_posts = posts.id_posts) as comments_reply FROM posts 
