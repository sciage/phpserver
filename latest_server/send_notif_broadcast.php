...
//	define("FCM_AUTH_KEY", "AAAADG3uq_Q:APA91bESlOMG-w-3D12ET82UGG-KlkdWoTUA-JMTU_QpE5wmgyhBTiylTAa2JEKyNjjINkqADEGzwVqydz9HnnxMkM2UOU_PVqCrfaFIFPpPmWs4-Cq4HVYsgTcBzDvXAQcX3Km6e-k7");
	...
	function testNotif(){
		...
		$notification = array (
					"title" => "New Candid App update available !",
					"body" => "Click here to update",
					//"message" => "Tap to check it out", /*toolbox*/
					// "clipboard" => "false", /*toolbox*/
		...
		$appPackage = array (
					"url" => "https://play.google.com/store/apps/details?id=in.beacandid.app.beacandid",
					"title" => "New Candid App update available",
					"message" => "Click here to update", /*toolbox install updates*/
					"clipboard" => "false", /*toolbox*/
					"postId" => "17177", /*toolbox*/
					"click_action" => "SHOW_POST_SCREEN",
					"sound" => true
				);
        ...
        $fcm_result = sendFCM($sub_id , $notification, $app);
