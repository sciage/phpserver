...
// Insert data into data base
    $sql = "INSERT INTO `user_name`( `name`, `email`, `userid`, `user_token`, `user_registered`,`deviceId`,`socialNetwork` ) 
        VALUES ('$name','$email','$user_id', '$bytes','$created','$bytes','$socialNetwork')";
