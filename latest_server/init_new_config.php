...
$con = mysqli_connect('35.238.41.23', 'F9ceab', 'hfhBMSKKy8h9y9YU', 'candid_database', 3306);
...
function return_responce($status = false, $data = NULL, $message = "Something Went Wrong", $action = ""){
	$return = array();
