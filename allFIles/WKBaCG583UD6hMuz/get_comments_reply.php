...
function get_reply($commentId){
	...
	$sql = "SELECT (SELECT username FROM user_name_random 
        ...
        (SELECT count(id_comment_reply_likes) FROM comment_reply_likes where id_post_comment_reply = 
        pcr.id_post_comment_reply) as comment_likes, (SELECT likes FROM comment_reply_likes 
        ...
        crl.post_comment_reply_id as post_comment_reply_id, pcr.comment_time as comment_time 
        FROM post_comment_reply pcr LEFT JOIN user_name u ON u.id_user_name=pcr.id_user_name	
        LEFT JOIN comment_reply_likes as crl ON crl.id_post_comment_reply = pcr.id_post_comment_reply 
